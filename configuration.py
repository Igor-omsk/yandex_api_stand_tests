...
URL_SERVICE = "https://07adb2e4-2e0c-4526-b061-e676ffcbb370.serverhub.praktikum-services.ru"
...
# LOG_MAIN_PATH содержит путь до логов сервера
LOG_MAIN_PATH = "/api/logs/main/"

# USERS_TABLE_PATH содержит путь до таблицы
